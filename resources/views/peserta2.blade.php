            ...
            <div class="col-auto">
              <form action="/peserta" method="GET"
                ...
                <div class="input-group" style="border-top-right-radius: 25px; border-bottom-right-radius: 25px;">
                  <input type="search" name="search" id="inputSearch" class="form-control bg-light"
                    placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2"
                    style="border-top-left-radius: 6px; border-bottom-left-radius: 6px; border-top-right-radius: 0; border-bottom-right-radius: 0;">
                ...
                <a href="/tambahpeserta" class="btn btn-success">Tambah Data</a>
              </form>
            </div>
              ...
              <div class="row">
                <div class="col-sm-12 col-md-5">
                  <div class="dataTables_info" id="bootstrap-data-table_info" role="status" aria-live="polite">
                    Menampilkan 1 sampai 5 dari 15 data</div>
                </div>
                <div class="col-sm-12 col-md-7">
                  <div class="dataTables_paginate paging_simple_numbers" id="bootstrap-data-table_paginate">
                    <ul class="pagination">
                      <li class="paginate_button page-item previous enabled" id="bootstrap-data-table_previous">
                        <a href="{{ $data->previousPageUrl() }}" aria-controls="bootstrap-data-table" data-dt-idx="0"
                          tabindex="0" class="page-link">Previous</a>
                      </li>
                      <li class="paginate_button page-item ">
                        <a href="/peserta" aria-controls="bootstrap-data-table" data-dt-idx="1" tabindex="0"
                          class="page-link">1</a>
                      </li>
                      <li class="paginate_button page-item "><a href="/peserta?page=2"
                          aria-controls="bootstrap-data-table" data-dt-idx="2" tabindex="0" class="page-link">2</a>
                      </li>
                      <li class="paginate_button page-item "><a href="/peserta?page=3"
                          aria-controls="bootstrap-data-table" data-dt-idx="3" tabindex="0" class="page-link">3</a>
                      </li>
                      <li class="paginate_button page-item next" id="bootstrap-data-table_next"><a
                          href="{{ $data->nextPageUrl() }}" aria-controls="bootstrap-data-table" data-dt-idx="7"
