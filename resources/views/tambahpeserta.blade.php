        ...
        <div class="card">
          <div class="card-body">
            <form action="/insertdata" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Pilih Fasilitator</label>
                <select class="form-select" name="fasilitator_id" id="fasilitator_id" aria-label="Default select example">
                  <option selected>Pilihan Fasilitator</option>
              ...
              <div class="mb-3">
                ...
                <select class="form-select" name="levelthn" aria-label="Default select example">
                  <option selected>Pilihan Tahun</option>
